...
function setup() {
  ...
  ground = new Ground(350, 790, 1200, 20);

  hero = new Hero(50,600,250);
  ...
  box23 = new Box(400, 100, 70, 70);
  box24 = new Box(400, 100, 70, 70);
  box25 = new Box(400, 100, 70, 70);
  box26 = new Box(400, 100, 70, 70);
